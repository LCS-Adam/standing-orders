...
Scan all task files in phases/ directories in order (a through h). Find the first file with status "IN PROGRESS" or "PENDING" (prefer IN PROGRESS over PENDING).
...
6. **Context:** any relevant open issues from docs/open-issues.md
